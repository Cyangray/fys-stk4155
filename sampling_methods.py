...
from statistical_functions import statistics

class sampling():
    def __init__(self, inst):
        self.inst = inst

    def kfold_cross_validation(self, k, design_matrix, method):
        ...
        for i in range(self.inst.k):
            ...
            X_test = inst.create_design_matrix('test')
